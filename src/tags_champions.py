...
def _generar_tags():
    ...
    if os.path.exists(ruta_campeones):
        ...
        for _cid, cname in campeones.items():
                ...
                for riot_name, riot_info in riot_data.items():
                    if riot_name.lower() == cname.lower():
                        ...
                        if "Mage" in riot_tags:
                            ...
                            tag.update({"damage_type": "AD", "champion_class": "Assassin", "sub_class": "Skirmisher"})
                        elif "Tank" in riot_tags:
                            tag.update({"damage_type": "AD", "champion_class": "Tank", "sub_class": "Vanguard"})
                        elif "Fighter" in riot_tags:
                            tag.update({"damage_type": "AD", "champion_class": "Fighter", "sub_class": "Diver"})
